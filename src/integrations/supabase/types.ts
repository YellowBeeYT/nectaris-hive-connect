  ...
  public: {
    Tables: {
      bookings: {
        ...
        Relationships: [
          {
            foreignKeyName: "bookings_beekeeper_id_fkey"
            columns: ["beekeeper_id"]
            isOneToOne: false
      ...
      favorites: {
        ...
        Relationships: [
          {
            foreignKeyName: "favorites_beekeeper_id_fkey"
            columns: ["beekeeper_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "admin" | "beekeeper" | "landowner"
      user_role: "beekeeper" | "landowner"
